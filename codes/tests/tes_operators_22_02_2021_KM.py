...
data_cubo = pd.read_table('Logfile/22_02_2021_12_36/data_mag.cvs', sep =',')
anomaly_cubo = np.reshape(np.array(data_cubo['Anomalia Magnética(nT)']), (20,20))

momento = 38/29 #3.8X10^1/ndip-1
#print(momento)
...
for t in range(n):
    ...
    gama, anomaly, MST, theta, phi = Operators_array.final_fit(X, Y, Z, I, D, populacao, anomaly_cubo, lamb = 5)
