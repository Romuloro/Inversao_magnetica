...
def my_trigonometrics_deg(angle):
    ...
    '''
    # Conversion factor 
    my_deg2rad = numpy.pi/180.
    # Calculate sine, cosine and tangent in radian
    mysin = numpy.sin(angle*my_deg2rad)
    mycos = numpy.cos(angle*my_deg2rad)
    mytan = numpy.tan(angle*my_deg2rad)
    # Return the final output
...
def my_trigonometrics_rad(angle):
    ...
    '''
    # Conversion factor 
    my_rad2deg = 180./numpy.pi
    # Calculate sine, cosine and tangent in radian
    mysin = numpy.sin(angle*my_rad2deg)
    mycos = numpy.cos(angle*my_rad2deg)
    mytan = numpy.tan(angle*my_rad2deg)
    # Return the final output
    return mysin, mycos, mytan
