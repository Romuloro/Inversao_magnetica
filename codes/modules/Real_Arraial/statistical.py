...
def my_analysis(data, unit = '(No Unit)'):  
    ...
    datamed = numpy.mean(data)
    datavar = datamax - datamin
    
    print ('Minimum:    %6.3f' % (datamin), unit)
    print ('Maximum:    %6.3f' % (datamax), unit)
    print ('Mean value: %6.3f' % (datamed), unit)
    print ('Variation:  %6.3f' % (datavar), unit)
